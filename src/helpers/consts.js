...
INVALID_EMAIL: `Invalid email. Please check if you mistyped anything. Enter again? Select from the menu below.`,
...
PROF_ROOM: `The professor is at {0}`,
PROF_CURRENT_CLASS: `The professor's current class is at {0}`,
PROF_NEXT: `The professor's next class is {0}`,
NO_PROF: `Sorry, I cannot find the professor you are looking for`,
MULTI_PROF: 'There are {0} professors with the same lastname. Please select which professor you are referring to: ',
DEFAULT: `Sorry, I didn't understand that. Would you like to leave your message for our admins to answer or would you like to chat with one now? Please select from the choices below`,
