...
module.exports.getDocuStatus =
    async (code, callback) => {
        var options = {
            method: 'GET',
            url: 'http://45c92cd6.ngrok.io/api/getStatus',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.nextClass =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            ...
            url: 'http://18b6eb3a.ngrok.io/api/getNextClass',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.room =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: 'http://18b6eb3a.ngrok.io/api/getRoom',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.currentClass =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: 'http://18b6eb3a.ngrok.io/api/getCurrentClass',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.subjectTime =
    async (session, firstname, professor, datetime, section, subject, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: 'http://18b6eb3a.ngrok.io/api/getSubjectTime',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.subjectDay =
    async (session, firstname, professor, datetime, section, subject, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: 'http://18b6eb3a.ngrok.io/api/getSubjectTimeWhen',
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
