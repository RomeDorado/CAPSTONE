...
async (code, callback)  => {
    var options = {
        method: 'GET',
        url: 'http://09e03c96.ngrok.io/api/getStatus',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
...
async (session, firstname, professor, datetime, callback)  => {    
    var options = {
        ...
        url: 'http://09e03c96.ngrok.io/api/getNextClass',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
...
async (session, firstname, professor, datetime, callback)  => {
    var options = {
        ...
        url: 'http://09e03c96.ngrok.io/api/getRoom',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
...
async (session, firstname, professor, datetime, callback)  => {
    var options = {
        method: 'GET',
        // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
        url: 'http://09e03c96.ngrok.io/api/getCurrentClass',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
...
async (session, firstname, professor, datetime, section, subject, callback)  => {
    var options = {
        method: 'GET',
        // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
        url: 'http://09e03c96.ngrok.io/api/getSubjectTime',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
...
async (session, firstname, professor, datetime, section, subject, callback)  => {
    var options = {
        method: 'GET',
        // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
        url: 'http://09e03c96.ngrok.io/api/getSubjectTimeWhen',
        headers: 
        {
            'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
            'content-type': 'application/json' 
