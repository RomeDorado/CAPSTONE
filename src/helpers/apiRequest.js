...
module.exports.nextClass =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            ...
            url: `${process.env.SCHEDULE.API}/getNextClass`,
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.room =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: `${process.env.SCHEDULE.API}/api/getRoom`,
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.currentClass =
    async (session, firstname, professor, datetime, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: `${process.env.SCHEDULE.API}/api/getCurrentClass`,
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.subjectTime =
    async (session, firstname, professor, datetime, section, subject, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: `${process.env.SCHEDULE.API}/api/getSubjectTime`,
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
...
module.exports.subjectDay =
    async (session, firstname, professor, datetime, section, subject, callback) => {
        var options = {
            method: 'GET',
            // url: 'https://iics-schedule-service.herokuapp.com/api/getRoom',
            url: `${process.env.SCHEDULE.API}/api/getSubjectTimeWhen`,
            headers:
                {
                    'API-Token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..A8jv7Gbqe61vfF3e1rdzrONbN0arB8vAEaNA6w509h8',
                    'content-type': 'application/json'
